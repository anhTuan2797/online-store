    ...
    if($stmt){
        ...
        while($stmt->fetch()){
          if($inStockField==0) echo "product is out of stock";
            ...
            echo"   ";
            echo "<input type=\"number\" id=\"formProductAmount\" min=\"1\" max=\"".$inStockField."\" value=\"1\">";
            echo"   ";
            echo"<button class = \"round-btn-green\" type=\"button\" onclick=\"addProductToOrder(".$idField.",".$PriceWithSale.")\">
